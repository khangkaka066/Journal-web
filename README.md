...
The report is generated by Vercel Cron at 09:00 New York on weekdays. Because New York switches between EST and EDT, `vercel.json` calls the cron route at both 13:00 and 14:00 UTC, and the API route only writes a report when New York time is actually 09:00.
